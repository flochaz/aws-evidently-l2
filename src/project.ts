import { Resource, IResource, Stack, ArnFormat } from 'aws-cdk-lib';
...
export class Project extends ProjectBase {
  ...
  public static fromProjectAttributes(
    ...
    class ImportedProject extends ProjectBase {
      ...
      public readonly projectName = Stack.of(scope).splitArn(
        attrs.projectArn,
  ...
  constructor(scope: Construct, id: string, props: ProjectProps) {
    ...
    this.projectName = this.getResourceNameAttribute(this.project.name);
  }
}
